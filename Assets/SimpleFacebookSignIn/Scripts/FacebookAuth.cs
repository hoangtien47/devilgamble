...
namespace Assets.SimpleFacebookSignIn.Scripts
{
    ...
    public partial class FacebookAuth
    {
        ...
        public FacebookAuth(FacebookAuthSettings settings = null)
        {
            ...
            SafariViewController.DidCompleteInitialLoad += UserCancelledHook;
        ...
        private void Auth()
        {
            ...
            _codeVerifier = $"{Guid.NewGuid()}{Guid.NewGuid()}";
        ...
        private void UserCancelledHook(bool loaded)
        {
            if (loaded) return;
        ...
        private void OnDeepLinkActivated(string deepLink)
        {
            ...
            if (_redirectUri == null || !deepLink.StartsWith(_redirectUri) || _codeVerifier == null) return;

            #if UNITY_IOS && !UNITY_EDITOR

            if (_settings.UseSafariViewController) SafariViewController.Close();
